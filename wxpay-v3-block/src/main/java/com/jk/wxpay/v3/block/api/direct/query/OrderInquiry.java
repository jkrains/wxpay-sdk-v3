...
public class OrderInquiry {
     ...
     * @return
     */
    public OrderQueryResult queryByOutTradeNo(String mchId, String tradeNo) {
     ...
     * @return
     */
    public OrderQueryResult queryByWechatTransactionId(String mchId, String transactionId) {
